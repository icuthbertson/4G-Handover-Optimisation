...
\subsection*{Movement:}
\begin{itemize}
\item	Positive X and Y movement.
\item	Positive X movement and Negative Y movement.
\item	Negative X movement and Positive Y Movement.
\item	Negative X and Y movement.
\item	Movement against left wall of simulation area.
\item	Movement against bottom wall of simulation area.
\item	Movement against right wall of simulation area.
\item	Movement against top wall of simulation area.
\end{itemize}
\subsection*{Path Loss:}
\begin{itemize}
\item	Received Path Loss correct.
\end{itemize}
\subsection*{Network Functions:}
\begin{itemize}
\item	Handovers working correctly.
\item	Drops working correctly.
\item	Ping-Pong's detected correctly.
\end{itemize}
\subsection*{Q-Learning:}
\begin{itemize}
\item	Q-Values updated correctly.
\item	Changing state correctly.
\item	Changing TTT and hys values correctly.
\end{itemize}
After the simulation was testing using the test cases above it was decided that the simulation was functioning correctly and was fit for use. The results of all the test cases can be seen in Appendix~\ref{testing}.
